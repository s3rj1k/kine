...
func (b *Backend) Update(ctx context.Context, key string, value []byte, revision, lease int64) (int64 /*revision*/, *server.KeyValue, bool, error) {
	rev, kv, err := b.Get(ctx, key, "", 0, revision)
	if err != nil {
		return revision, kv, false, err
	}
